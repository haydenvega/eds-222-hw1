...
1.  What is the *population* in this setting? Please be precise.
    ...
    -   The population that we're interested in the average air pollution throughout the entire city of Lahore.
...
sample_map \<- ggplot(both, aes(latitude, longitude, color = id))+
