...
1.  What is the *population* in this setting? Please be precise.
    ...
    -   The population that we're interested in the average air pollution throughout the entire city of Lahore over the given period of time.

2.  What are the *samples* in this setting? Please be precise.

    -   The samples are the areas where monitors are collecting data. In this case we have two samples: crowdsourced and government, both taken from 10/4/18-10/30/19. We separate these samples because they take different approaches to collecting their data.
...
3.  Are the differences in mean pollution as expected, given what we know about the sampling strategies?
    -   <div>
        ...
        Yes! We would expect to see the government sites with cleaner air (less PM) than crowd-sourced sites because government officials pick clean areas to sample.
